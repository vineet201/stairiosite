        ...
        <PricingModule
          ...
          plans={[
            ...
            features: [
              ...
              { label: "Admin Dashboard (Pro)", included: true },
              { label: "Guest Management (Pro)", included: true },
              { label: "Multi-Property Support", included: true },
              { label: "Staff & Housekeeping", included: true },
              { label: "Inventory Management", included: true },
              { label: "Revenue Management", included: true },
          ...
          },
          {
            ...
            features: [
              ...
              { label: "Seasonal Pricing", included: true },
              { label: "Walk-in Booking", included: true },
              { label: "Automation (Billing & Ops)", included: true },
              { label: "AI Features", included: true },
              { label: "Advance PMS", included: true },
              { label: "Priority Support", included: true },
              { label: "Multi-Property", included: false },
              { label: "Staff & Housekeeping", included: false },
            ],
            recommended: true,
          },
          {
            ...
            features: [
              ...
              { label: "Admin Dashboard (Advanced)", included: true },
              { label: "Guest Management (Advanced)", included: true },
              { label: "Billing & GST Invoicing", included: true },
              { label: "Reports & Analytics", included: true },
              { label: "Booking Modification", included: true },
              { label: "Google Analytics + SEO", included: true },
              { label: "WhatsApp Notifications", included: false },
              { label: "Channel Manager", included: false },
              { label: "Multi-Room Types", included: false },
              { label: "Seasonal Pricing", included: false },
            ],
          },
          {
            id: "starter",
            ...
            features: [
              ...
              { label: "Payment Integration (Razorpay)", included: true },
              { label: "Domain + Hosting + SSL", included: true },
              { label: "Same-Day Payment Settlement", included: true },
              { label: "Guest Data Ownership", included: true },
              { label: "Website (Basic)", included: true },
              { label: "Admin Dashboard (Basic)", included: true },
              { label: "Guest Management (Basic)", included: true },
              { label: "Billing & GST Invoicing", included: false },
